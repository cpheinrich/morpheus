...
interface Invocation { flags: Flags; command: string | undefined; rest: string[]; dir: string; }

async function dispatchSelf({ flags, command, rest }: Invocation): Promise<number> {
...
async function dispatchHeartbeat({ flags, dir }: Invocation): Promise<number> {
    return heartbeat({
      productDir: dir,
      cwd: process.cwd(),
...
async function dispatchVoice({ flags, command, rest, dir }: Invocation): Promise<number> {
...
async function dispatchTokens({ flags, command }: Invocation): Promise<number> {
...
async function dispatchResearchLibrary({ flags, command, rest }: Invocation): Promise<number> {
    if (command === "init") {
...
async function dispatchInit({ flags, command, rest }: Invocation): Promise<number> {
    if (command === "status") {
...
async function dispatchWeb({ flags, command }: Invocation): Promise<number> {
...
async function dispatchRegistry({ flags, command, rest }: Invocation): Promise<number> {
...
async function dispatchHq({ flags, command }: Invocation): Promise<number> {
    if (command === "rules") {
...
async function dispatchAccess({ flags, command }: Invocation): Promise<number> {
...
async function dispatchFirebase({ flags, command, rest }: Invocation): Promise<number> {
    if (command !== "auth") {
...
async function dispatchBrand({ flags, command, dir }: Invocation): Promise<number> {
...
async function dispatchInbox({ flags, command, dir }: Invocation): Promise<number> {
    if (command === "validate") {
...
async function dispatchTeam({ command }: Invocation): Promise<number> {
...
async function dispatchPm({ flags, command, rest, dir }: Invocation): Promise<number> {
  switch (command) {
    case "validate":
      return validate(dir);
    case "index":
...
export async function dispatch(flags: Flags): Promise<number> {

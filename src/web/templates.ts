 ...
 */
export const waitlistRecordTest = (ctx: TemplateContext, runner: "vitest" | "node"): string => {
...
export const signInPage = (ctx: TemplateContext, name: string, emailDomain?: string): string => {

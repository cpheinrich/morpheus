...
export const waitlistSchema = (): string => `/**
...
export const waitlistRecord = (ctx: TemplateContext): string => {
...
export const waitlistThrottle = (): string => `/**
...
export const waitlistRoute = (ctx: TemplateContext): string => {
...
export const waitlistForm = (ctx: TemplateContext): string => {
 ...
 */
export const waitlistRecordTest = (
  ctx: TemplateContext,
  runner: "vitest" | "node",
...
export const firebaseConfigFile = (facts: FirebaseFacts): string => {
...
export const firebaseClient = (ctx: TemplateContext): string => {
...
export const firebaseAdmin = (ctx: TemplateContext, facts: FirebaseFacts): string => {
...
export const authSessionCookie = (ctx: TemplateContext): string => {
...
export const authCurrentUser = (ctx: TemplateContext): string => {
...
export const routeGate = (ctx: TemplateContext): string => {
  const self = "proxy.ts";
...
export const apiAuthSession = (ctx: TemplateContext, name: string): string => {
 ...
 */
export const signInPage = (ctx: TemplateContext, name: string): string => {
...
export const signInForm = (ctx: TemplateContext): string => {
...
export const signOutButton = (ctx: TemplateContext): string => {
...
export const hqSearch = (name: string): string => `"use client";
...
export const hqSearchBuild = (name: string): string => `import {
...
export const hqSearchRoute = (ctx: TemplateContext): string => {
...
export const hqLayout = (ctx: TemplateContext, name: string): string => {
...
export const hqPage = (ctx: TemplateContext, name: string): string => {
...
export const noAccessPage = (): string => `import type { Metadata } from "next";
...
export const appPackageJson = (scope: string, sharedName?: string): string =>
  `${JSON.stringify(
    {
      name: `${scope}/web`,
      version: "0.1.0",
...
export const nextConfig = (): string => `import type { NextConfig } from "next";
...
export const postcssConfig = (): string => `const config = {
...
export const globalsCss = (): string => `@import "tailwindcss";
...
export const rootLayout = (name: string, description: string): string =>
...
export const homePage = (ctx: TemplateContext, name: string, description: string): string => {
...
export const envExample = (facts?: FirebaseFacts): string => `# Committed, with no values. The only record of which variables exist —
# without it a new machine finds out by crashing.

# Firebase Admin credentials.
#
# Nothing needs to be set locally: \`gcloud auth application-default login\`
# supplies Application Default Credentials under \`next dev\`.${
...
export const readmeSection = (name: string, hasHq: boolean, hasWaitlist: boolean): string => {
  const rows = [
    hasWaitlist &&

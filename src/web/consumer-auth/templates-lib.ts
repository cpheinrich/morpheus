...
export const libFirebaseConfig = (ctx: Ctx): string => `/**
...
export const libFirebaseAdmin = (ctx: Ctx): string => `import "server-only";
...
export const libFirebaseClient = (ctx: Ctx): string => `"use client";
...
export const libFirebaseEmulator = (ctx: Ctx): string => `import { resolve } from "node:path";
...
/** lib/auth/roles.ts */
export const libAuthRoles = (ctx: Ctx): string => `/**
...
export const libAuthSessionCookie = (ctx: Ctx): string => `import { decodeJwt, importX509, jwtVerify, type JWTPayload } from "jose";
...
export const libAuthCurrentUser = (ctx: Ctx): string => `import "server-only";
...
export const libAuthWritingUser = (ctx: Ctx): string => `import "server-only";
...
export const libAuthRequestOrigin = (ctx: Ctx): string => `/**
...
export const libAuthSafeNext = (ctx: Ctx): string => `/**
...
export const libAuthActionLink = (ctx: Ctx): string => `/**
...
export const libAuthSendActionEmail = (ctx: Ctx): string => `import "server-only";
...
export const libAuthSessionClient = (ctx: Ctx): string => `"use client";
...
/** lib/auth/errors.ts */
export const libAuthErrors = (ctx: Ctx): string => `/**
...
/** lib/email/send.ts */
export const libEmailSend = (ctx: Ctx): string => `import "server-only";
...
export const libEmailTemplates = (ctx: Ctx): string => `import type { Email } from "@/lib/email/send";
...
/** lib/users/decode.ts */
export const libUsersDecode = (ctx: Ctx): string => `/**
...
/** lib/users/store.ts */
export const libUsersStore = (ctx: Ctx): string => `import "server-only";
...
export const sharedUserSchema = (ctx: Ctx): string => `/**

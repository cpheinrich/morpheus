...
export const apiAuthSessionRoute = (ctx: Ctx): string => `import { NextResponse } from "next/server";
...
export const apiResetPasswordRoute = (ctx: Ctx): string => `import { NextResponse } from "next/server";
...
export const apiAccountRoute = (ctx: Ctx): string => `import { NextResponse } from "next/server";
...
export const apiVerifyEmailRoute = (ctx: Ctx): string => `import { NextResponse } from "next/server";
...
export const signInPage = (ctx: Ctx): string => `import type { Metadata } from "next";
...
export const signInForm = (ctx: Ctx): string => `"use client";
...
export const googleButton = (ctx: Ctx): string => `"use client";
...
export const signUpPage = (ctx: Ctx): string => `import type { Metadata } from "next";
import { redirect } from "next/navigation";
...
export const signUpForm = (ctx: Ctx): string => `"use client";
...
export const resetPasswordPage = (ctx: Ctx): string => `import type { Metadata } from "next";
...
export const resetPasswordForm = (ctx: Ctx): string => `"use client";
...
export const authActionPage = (ctx: Ctx): string => `import type { Metadata } from "next";
...
export const authActionHandler = (ctx: Ctx): string => `"use client";
...
/** app/app/layout.tsx */
export const appLayout = (ctx: Ctx): string => `import type { Metadata } from "next";
import Link from "next/link";
...
/** app/app/page.tsx */
export const appPage = (ctx: Ctx): string => `import { redirect } from "next/navigation";
...
export const verifyBanner = (ctx: Ctx): string => `"use client";
...
export const displayNameForm = (ctx: Ctx): string => `"use client";
...
/** app/NavAuth.tsx */
export const navAuth = (ctx: Ctx): string => `"use client";
...
export const signOutButton = (ctx: Ctx): string => `"use client";
...
/** proxy.ts */
export const routeGate = (ctx: Ctx): string => `import { NextResponse, type NextRequest } from "next/server";

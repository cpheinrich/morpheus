...
export function parseTrunk(ref) {
 ...
 */
export async function resolveTrunk(root, declared) {
    if (declared)
        return parseTrunk(declared);
 ...
 */
export async function trunkSha(root, trunk) {
 ...
 */
export async function worktreeRoot(root) {
 ...
 */
export async function trunkLog(root, trunk, from, to) {

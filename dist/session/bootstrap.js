...
- \`bootstrap.sh enable\` runs only after an explicit yes. It clones reviewed Morpheus \`main\`
  into a disposable directory, invokes that clone's committed CLI directly, installs the current
  standalone package, registers this project, and enables the managed Git hooks.

 ...
 */
export const isoDate = z.preprocess((v) => (v instanceof Date ? v.toISOString().slice(0, 10) : v), z.iso.date());
/**
 ...
 */
export const isoDateTime = z.preprocess((v) => (v instanceof Date ? v.toISOString() : v), z.iso.datetime({ offset: true }));
/**
 ...
 * has to meet it.
 */
export const looseString = z.preprocess((v) => (typeof v === "number" || typeof v === "boolean" ? String(v) : v), z.string().min(1));
/**
...
export const Goal = z
    ...
    if (!segment)
        return true; // the regex above already reported this

import { type SessionClaims } from "./session-cookie.js";
/**
 ...
 */
export declare function decideFromClaims(claims: SessionClaims | null, opts?: Pick<HqGateOptions, "signInPath" | "noAccessPath">): HqDecision;
export declare function decideHqAccess(opts: HqGateOptions): Promise<HqDecision>;

...
export interface SessionCookieMinter {
    createSessionCookie(idToken: string, options: {
        expiresIn: number;
    }): Promise<string>;
}
...
export declare const HQ_SESSION: {
     ...
     */
    readonly minExpiresInMs: number;
    /**
     ...
     */
    readonly renewAfterFraction: 0.5;
};
/**
 ...
 */
export declare function clampExpiresIn(expiresInMs: number): number;
/**
 ...
 * ```
 */
export declare function createHqSessionCookie(auth: SessionCookieMinter, idToken: string, expiresInMs?: number): Promise<{
    value: string;
    expiresInMs: number;
}>;
/**
 ...
 */
export declare function hqSessionCookieOptions(opts?: {
    expiresInMs?: number;
    secure?: boolean;
    path?: string;
}): HqCookieOptions;
 ...
 */
export declare function hqSessionClearOptions(opts?: {
    secure?: boolean;
    path?: string;
}): HqCookieOptions;
/**
 ...
 */
export declare function renewalDue(payload: {
    iat?: number | null;
    exp?: number | null;
}, now?: number): boolean;

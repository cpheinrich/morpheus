...
export const unitAuthConfigTest = (ctx) => `import assert from "node:assert/strict";
...
export const unitActionLinkTest = (ctx) => `import assert from "node:assert/strict";
import { describe, it } from "node:test";
...
export const unitRequestSafetyTest = (ctx) => `import assert from "node:assert/strict";
import { describe, it } from "node:test";
...
export const unitUserProfileTest = (ctx) => `import assert from "node:assert/strict";
import { describe, it } from "node:test";
...
export const rulesTest = (ctx) => `// Rules unit tests for the consumer \`users\` collection in firestore.rules.
//
...
export const e2eEmulatorHelper = (ctx) => `/**
...
export const e2eAccountsHelper = (ctx) => `import { expect, type Page } from "@playwright/test";
...
`;
/** e2e/sign-in.spec.ts */
export const e2eSignInSpec = (ctx) => `import { expect, test } from "@playwright/test";
...
export const e2eSignUpVerifySpec = (ctx) => `import { expect, test } from "@playwright/test";
...
export const e2ePasswordResetSpec = (ctx) => `import { expect, test } from "@playwright/test";
...
export const e2eSessionSecuritySpec = (ctx) => `import { expect, test } from "@playwright/test";
...
export const e2eUnverifiedLockoutSpec = (ctx) => `import { expect, test } from "@playwright/test";
...
export const playwrightConfig = (ctx) => `import { defineConfig, devices } from "@playwright/test";

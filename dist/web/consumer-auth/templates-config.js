 ...
 */
export const firebaseJson = (rulesPath) => `${JSON.stringify({ firestore: { rules: rulesPath }, emulators: EMULATORS_BLOCK }, null, 2)}\n`;
/** The thin CI delegator, calling the reusable workflow beside web-ci's. */
export const ciCaller = () => `name: Firebase tests

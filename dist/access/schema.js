 ...
 */
export function resolveEntries(hq) {
    const byEmail = new Map();
    for (const email of hq.investorAllowlist)
        byEmail.set(email.toLowerCase(), "investor");
    for (const email of hq.allowlist)
        byEmail.set(email.toLowerCase(), "employee");
    for (const email of hq.admins)
        byEmail.set(email.toLowerCase(), "admin");

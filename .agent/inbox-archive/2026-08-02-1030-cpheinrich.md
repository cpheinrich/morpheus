...
~ Don't worry about the other keys - we'll come back to them. 
...
~ We can go with A and see how Sonnet does. Why did #69 need five review passes? Could we reduce the number of passes?
...
~ Set it to run on the hour, every hour, every day of the week. If there is nothing to do then it is cheap. 

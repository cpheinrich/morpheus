...
---
# Inbox — 2026-07-29 06:00 (archived)

> Replied to and acted on. Durable outcomes are in [`../decisions.md`](../decisions.md).
...
All one-time, none hard. Queued as [MO-012](product/roadmap/MO-26-07-29-012-make-morpheus-private-adjust.md).
...
Agreed and reprioritized. [MO-006](product/roadmap/MO-26-07-28-006-kit-analytics-posthog-setup.md) stays in backlog.
...
argument: opening `MO-003.md` rendered *our* frontmatter as typed form fields — ID, TITLE,
...
```sh
morpheus pm claim MO-014      # errors if origin already has rm-014-*

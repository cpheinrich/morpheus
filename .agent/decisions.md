...
per-user crash-recoverable lock, leaves it shut down, and runs every test on a uniquely owned
...
dependencies. The action keeps its small macOS-specific atomic-directory lock in Node built-ins.
